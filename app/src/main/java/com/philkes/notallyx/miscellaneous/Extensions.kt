...
import com.philkes.notallyx.activities.TakeNote
import com.philkes.notallyx.changehistory.ChangeHistory
import com.philkes.notallyx.changehistory.EditTextChange
import com.philkes.notallyx.model.FileAttachment
import com.philkes.notallyx.model.SpanRepresentation
...
fun TextView.displayFormattedTimestamp(timestamp: Long, dateFormat: String) {
    if (dateFormat != com.philkes.notallyx.preferences.DateFormat.none) {
...
private fun formatTimestamp(timestamp: Long, dateFormat: String): String {
    ...
    return when (dateFormat) {
        com.philkes.notallyx.preferences.DateFormat.relative -> PrettyTime().format(date)
